...
export const DEFAULT_ROUTINES = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        ttsCues: [
          { time: 0, text: '下一個動作，肩部繞環。雙肩由前向上、向後繞環。保持深沉有規律的呼吸。' },
          { time: 10, text: '現在反方向。雙肩由後向上、向前滾動，帶走肩膀的疲勞與緊繃。' },
          { time: 17, text: '三，二，一，結束動作。' },
        ],
      },
      {
        id: 'chest-opener',
      ...
      },
      {
        ...
        ttsCues: [
          ...
          { time: 27, text: '三，二，一，吸氣，從尾椎開始，慢慢捲脊站立回正。' },
        ],
      },
    ],
  },
    ...
    steps: [
      ...
      },
      {
        ...
        ttsCues: [
          ...
          { time: 42, text: '三，二，一，雙手推地，慢慢起身上身回正。' },
        ],
      },
      {
        id: 'neck-tilt',
